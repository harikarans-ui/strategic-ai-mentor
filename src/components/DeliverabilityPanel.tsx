...
const DeliverabilityPanel = () => {
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {/* Overall Score */}
      <div className="bg-card rounded-xl border border-primary/20 p-6 shadow-sm glow-primary">
        <div className="flex items-center gap-6">
          <div className="relative w-24 h-24">
            <svg className="w-24 h-24 -rotate-90" viewBox="0 0 100 100">
              <circle cx="50" cy="50" r="40" fill="none" stroke="hsl(220, 15%, 88%)" strokeWidth="8" />
              <circle cx="50" cy="50" r="40" fill="none" stroke="hsl(220, 78%, 44%)" strokeWidth="8"
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <span className="text-xs text-primary font-medium">AI predicts 94.2% inbox placement for your next campaign</span>
            </div>
          </div>
        </div>
      </div>
