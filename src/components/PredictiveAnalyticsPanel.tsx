import { BarChart3, MessageSquare, Sparkles, Target, TrendingUp } from "lucide-react";
        ...
        <div className="h-64">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={revenueData}>
              ...
              <Tooltip
                contentStyle={{ background: "#fff", border: "1px solid hsl(220, 15%, 88%)", borderRadius: "8px", color: "hsl(220, 30%, 15%)" }}
              />
              <Area type="monotone" dataKey="actual" stroke="hsl(220, 78%, 44%)" fill="url(#colorActual)" strokeWidth={2} />
              <Area type="monotone" dataKey="predicted" stroke="hsl(36, 90%, 55%)" fill="url(#colorPredicted)" strokeWidth={2} strokeDasharray="5 5" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </div>
