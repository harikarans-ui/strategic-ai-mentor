    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="bg-card rounded-xl border border-border p-6 shadow-sm">
        ...
        <textarea
          ...
          className="w-full bg-muted border border-border rounded-lg px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 resize-none"
        />
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {contentTypes.map((ct, i) => (
          <div
            key={i}
            className="bg-card rounded-xl border border-border p-5 hover:border-primary/30 transition-all cursor-pointer group shadow-sm"
          >
      ...
      <div className="bg-card rounded-xl border border-border p-6 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-2">
            <span className="px-2 py-1 rounded-full bg-primary/10 text-primary text-xs font-medium">Version A</span>
            <span className="px-2 py-1 rounded-full bg-muted text-muted-foreground text-xs">Version B</span>
            <span className="px-2 py-1 rounded-full bg-muted text-muted-foreground text-xs">Version C</span>
          </div>
        </div>
        <div className="bg-muted rounded-lg p-6 border border-border">
          <div className="space-y-3">
            ...
            <div className="border-t border-border pt-3">
              ...
              <div className="h-4 bg-border rounded w-5/6 mb-4" />
